...
class MyUi(Ui_MainWindow):
    ...
    def plotData(self):
        ...
        try:
            ...
            penX = pg.mkPen((100, 200, 250), width=2, style=QtCore.Qt.SolidLine)
            self.BxPlot.clear()
            self.BxPlot.plot(timeB, bx, pen=penX)

            penY = pg.mkPen((100, 250, 200), width=2, style=QtCore.Qt.SolidLine)
            self.ByPlot.clear()
            self.ByPlot.plot(timeB, by, pen=penY)

            penZ = pg.mkPen((250, 100, 200), width=2, style=QtCore.Qt.SolidLine)
            self.BzPlot.clear()
            ...
            self.BxLabel.setText("{:+10.2f}".format(bxmean))
            self.ByLabel.setText("{:+10.2f}".format(bymean))
            self.BzLabel.setText("{:+10.2f}".format(bzmean))

            self.BtLabel.setText("{:+10.2f}".format(btmean))

            p = np.array(self.vmr.cbP)
            self.PLabel.setText("{:6.3f}".format(np.mean(p[-10:])))




            self.XYPlot.setLabel('bottom', "X")
            self.XYPlot.setLabel('left', "Y")
            self.XZPlot.setLabel('bottom', "X")
            self.XZPlot.setLabel('left', "Z")
            self.YZPlot.setLabel('bottom', "Y")
            self.YZPlot.setLabel('left', "Z")
            ...
            self.XYPlot.plot(bxs, bys, symbol='o')
            self.XYPlot.plot(mx, my, symbol='+')
            #self.XYPlot.setXRange(-maxxy, maxxy, padding=0)
            #self.XYPlot.setYRange(-maxxy, maxxy, padding=0)

            self.XZPlot.plot(bxs, bzs, symbol='o')
            self.XZPlot.plot(mx, mz, symbol='+')
